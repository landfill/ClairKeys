...
|---:|---|---|---|---|---|
| 0 | DOC-1 | 기본 브랜치 `main` 전환 | IN_PROGRESS | `codex/default-branch-main-migration` | DOC-0 |
| 1 | P0-A | 애니메이션 계약과 golden fixture 확립 | BLOCKED | `codex/p0-animation-contract` | DOC-1 |
| 2 | P0-B | MusicXML 변환 정확도 재구현 | NOT_STARTED | `codex/p0-musicxml-converter` | P0-A |
| 3 | P0-C | 오디오·애니메이션 동기화 복구 | NOT_STARTED | `codex/p0-playback-sync` | P0-A, P0-B |
| 4 | P0-D | 인증·타입·테스트·CI 기준선 복구 | BLOCKED | `codex/p0-quality-gates` | DOC-1 |
