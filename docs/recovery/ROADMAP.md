...
|---:|---|---|---|---|---|
| 1 | P0-A | 애니메이션 계약과 golden fixture 확립 | BLOCKED | `codex/p0-animation-contract` | 문서 체계 PR 병합 |
...
| 4 | P0-D | 인증·타입·테스트·CI 기준선 복구 | BLOCKED | `codex/p0-quality-gates` | 문서 체계 PR 병합 |
