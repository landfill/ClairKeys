...
1. **다음 기전을 고른다. D-065는 배포·운영 확인까지 끝났다.** 남은 후보: C m5 빈 머리 → 셋잇단,
   B 2도 반대편 머리 누락(둘 다 단계 추적 필요), E m3 둘잇단 미지원(범위가 커서 보류 후보).
   D-065의 후속 과제도 열려 있다: 두께로 거부한 후보를 `rawSystemBeams`에 남기지 않으면 진짜 빔까지 살릴 가능성이 있으나
