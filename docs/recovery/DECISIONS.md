...
- Tested: focused Jest에서 관련 3 suites / 66 tests 통과, corpus report에서 61/171·0/154·2 확인,
  결정론과 원본 finger 보존 회귀 통과.
- Not-tested: 전체 Jest, typecheck, lint, build, 12,000음 성능, 전문 피아니스트 검수는 이 결정 작성 시점에
  아직 실행하지 않았다.
